...
# 5. Simulate individual interventions
...
# 7. Save results
results.to_csv("xgb_stunting_intervention_simulation.csv", index=False)
print("✅ Saved to xgb_stunting_intervention_simulation.csv")
